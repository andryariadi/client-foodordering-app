...
const CartPage = () => {
  return (
    <>
      <div className="flex flex-col lg:flex-row h-screen justify-center items-center text-rose-600 mt-5">
        <div className="cart-container flex-1 h-full w-full p-4 flex flex-col md:flex-row justify-center md:flex-wrap overflow-y-scroll lg:p-20 xl:p-30">
        ...
        <div className="bg-fuchsia-50 flex-1 h-full w-full p-4 flex flex-col gap-4 justify-center lg:p-20 xl:p-30 2xl:text-xl 2xl:gap-6">
          ...
          <button className="bg-rose-600 text-white p-2 rounded-md self-end text-base">Check Out</button>
        </div>
      </div>
    </>
  );
